...
public class SimpleMarketStatusByMICTest {
    ...
    private final SimpleMarketStatusByMIC micSimpleMarketStatus = new SimpleMarketStatusByMIC();
...
//    }
    ...
    public void testOpenAuctionTimeWindow() {
        ...
        assertEquals(MarketStatusByMIC.MARKET_PHASES.OPEN_AUCTION, micSimpleMarketStatus.getMarketPhase(currentTime, "XLON"));
    }
    ...
    public void testClosedAuctionTimeWindowLondon() {
        ...
        assertEquals(MarketStatusByMIC.MARKET_PHASES.CLOSING_AUCTION, micSimpleMarketStatus.getMarketPhase(currentTime, "XLON"));
    }
    ...
    public void testIsNYSEOpenOnATuesdayEvening() {
        ...
        assertEquals(MarketStatusByMIC.MARKET_PHASES.CLOSED, micSimpleMarketStatus.getMarketPhase(currentTime, "XNYS"));
    }
    ...
    public void testHongKongMarketClosedSaturday() {
        ...
        assertEquals(MarketStatusByMIC.MARKET_PHASES.CLOSED, micSimpleMarketStatus.getMarketPhase(currentTime, "XHKG"));
    }
    ...
    public void testAustraliaMarketClosedSunday() {
        ...
        assertEquals(MarketStatusByMIC.MARKET_PHASES.CLOSED, micSimpleMarketStatus.getMarketPhase(currentTime, "XASX"));
    }
}
