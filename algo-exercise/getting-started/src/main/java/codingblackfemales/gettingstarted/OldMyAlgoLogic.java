...
public class OldMyAlgoLogic implements AlgoLogic {

    private static final Logger logger = LoggerFactory.getLogger(OldMyAlgoLogic.class); // to track events, errors, or important information specifically within the MyAlgoLogic class
    ...
    public Action evaluate(SimpleAlgoState state) {
        ...
        for (ChildOrder childOrder : activeChildOrders) {
            if (childOrder.getState() == OrderState.FILLED) { // cancel first order not if it's filed state 
