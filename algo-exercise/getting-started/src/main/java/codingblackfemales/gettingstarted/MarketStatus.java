...
public class MarketStatus {
    ...
    public boolean isMarketOpen() {
        ...
        return timeNow.isAfter(marketOpenDateTime) || timeNow.isBefore(marketCloseDateTime) || today.getDayOfWeek() != DayOfWeek.SATURDAY || today.getDayOfWeek() != DayOfWeek.SUNDAY; // Market is open at 8am and closed before 8am & after 4.35pm & on weekend
    }
}
